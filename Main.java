            ...
            try {
                ...
                if (input == 0) {
                    ...
                    try {
                        ...
                        if(email.length() > 45) {
                            throw new MaximumSizeException("The email must have less than " + 45 + " characters in length");
                        }
                        ...
                        if(password.length() > 45) {
                            throw new MaximumSizeException("The password must have less than " + 45 + " characters in length");
                        }
                        ...
                        if(username.length() > 45) {
                            throw new MaximumSizeException("The username must have less than " + 45 + " characters in length");
                        }
